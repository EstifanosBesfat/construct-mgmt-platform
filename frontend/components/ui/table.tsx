...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-muted/60 border-b border-border', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-8 px-3 text-left align-middle text-[11px] font-semibold text-muted-foreground uppercase tracking-wider select-none whitespace-nowrap',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('px-3 py-2 align-middle text-xs text-foreground whitespace-nowrap', className)}
    {...props}
  />
));
